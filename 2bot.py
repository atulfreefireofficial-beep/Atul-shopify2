...
# Status emojis for card checking
CUSTOM_STATUS_EMOJIS = {
    "charged": '<tg-emoji emoji-id="5891044423856296980">💎</tg-emoji>',
    "order_complete": '<tg-emoji emoji-id="5226656353744862682">🎉</tg-emoji>',
    "approved": '<tg-emoji emoji-id="6087133294648890399">✅</tg-emoji>',
    "declined": '<tg-emoji emoji-id="5042112436648281096">❌</tg-emoji>',
    "time": '<tg-emoji emoji-id="6179440452601647526">⏱️</tg-emoji>',
    "card": '<tg-emoji emoji-id="5472250091332993630">💳</tg-emoji>',
    "price": '<tg-emoji emoji-id="5453901475648390219">💰</tg-emoji>',
}

# UI and other emojis
LIVE_EMOJIS = {
    "check": '<tg-emoji emoji-id="6136204644625423818">🔄</tg-emoji>',
    "order": '<tg-emoji emoji-id="5226656353744862682">🛒</tg-emoji>',
    "file": '<tg-emoji emoji-id="5463424023734014980">🐍</tg-emoji>',
    "gate": '<tg-emoji emoji-id="6321225560789877992">🌐</tg-emoji>',
    "user": '<tg-emoji emoji-id="5958417144877160497">👤</tg-emoji>',
    "proxy": '<tg-emoji emoji-id="5042101437237036298">🔒</tg-emoji>',
    ...
    "key": '<tg-emoji emoji-id="5226656353744862682">🔑</tg-emoji>',
    "redeem": '<tg-emoji emoji-id="5041975203853239332">🎁</tg-emoji>',
    "plan": '<tg-emoji emoji-id="5463172695132745432">📦</tg-emoji>',
    "payment": '<tg-emoji emoji-id="5463046637842608206">💸</tg-emoji>',
    "upi": '<tg-emoji emoji-id="5201873447554145566">🏦</tg-emoji>',
    "dm": '<tg-emoji emoji-id="5372957680174384345">📩</tg-emoji>',
    "back": '<tg-emoji emoji-id="5253997076169115797">🔙</tg-emoji>',
    "checked": '<tg-emoji emoji-id="5278622189556354905">✔️</tg-emoji>',
    "rocket": '<tg-emoji emoji-id="5195033767969839232">🚀</tg-emoji>',
    "fire": '<tg-emoji emoji-id="5983168105101135589">🔥</tg-emoji>',
    "heart": '<tg-emoji emoji-id="5280745939215073717">❤️</tg-emoji>',
    "sparkle": '<tg-emoji emoji-id="5278251134446748886">✨</tg-emoji>',
    "bin": '<tg-emoji emoji-id="5854784287013867183">🔍</tg-emoji>',
    "leaderboard": '<tg-emoji emoji-id="5188344996356448758">🏆</tg-emoji>',
    "broadcast": '<tg-emoji emoji-id="5298609030321691620">📢</tg-emoji>',
    "admin": '<tg-emoji emoji-id="5278394972901492572">🛡️</tg-emoji>',
    "globe": '<tg-emoji emoji-id="5224450179368767019">🌍</tg-emoji>',
    "remove": '<tg-emoji emoji-id="5463121572137022242">➖</tg-emoji>',
    "skipped": '<tg-emoji emoji-id="5278251134446748886">⏭️</tg-emoji>',
}

# Create simplified variables using the live emojis
CHECK_EMOJI = LIVE_EMOJIS["check"]
CHARGED_EMOJI = CUSTOM_STATUS_EMOJIS["charged"]
APPROVED_EMOJI = CUSTOM_STATUS_EMOJIS["approved"]
DECLINED_EMOJI = CUSTOM_STATUS_EMOJIS["declined"]
ORDER_EMOJI = LIVE_EMOJIS["order"]
FILE_EMOJI = LIVE_EMOJIS["file"]
TIME_EMOJI = CUSTOM_STATUS_EMOJIS["time"]
CARD_EMOJI = CUSTOM_STATUS_EMOJIS["card"]
GATE_EMOJI = LIVE_EMOJIS["gate"]
PRICE_EMOJI = CUSTOM_STATUS_EMOJIS["price"]
USER_EMOJI = LIVE_EMOJIS["user"]
PROXY_EMOJI = LIVE_EMOJIS["proxy"]
STATS_EMOJI = LIVE_EMOJIS["stats"]
CROWN_EMOJI = LIVE_EMOJIS["crown"]
STAR_EMOJI = LIVE_EMOJIS["star"]
WARNING_EMOJI = LIVE_EMOJIS["warning"]
INFO_EMOJI = LIVE_EMOJIS["info"]
LOCK_EMOJI = LIVE_EMOJIS["lock"]
TRASH_EMOJI = LIVE_EMOJIS["trash"]
ADD_EMOJI = LIVE_EMOJIS["add"]
KEY_EMOJI = LIVE_EMOJIS["key"]
REDEEM_EMOJI = LIVE_EMOJIS["redeem"]
PLAN_EMOJI = LIVE_EMOJIS["plan"]
PAYMENT_EMOJI = LIVE_EMOJIS["payment"]
UPI_EMOJI = LIVE_EMOJIS["upi"]
DM_EMOJI = LIVE_EMOJIS["dm"]
BACK_EMOJI = LIVE_EMOJIS["back"]
CHECKED_EMOJI = LIVE_EMOJIS["checked"]
ROCKET_EMOJI = LIVE_EMOJIS["rocket"]
FIRE_EMOJI = LIVE_EMOJIS["fire"]
HEART_EMOJI = LIVE_EMOJIS["heart"]
SPARKLE_EMOJI = LIVE_EMOJIS["sparkle"]
BIN_EMOJI = LIVE_EMOJIS["bin"]
LEADERBOARD_EMOJI = LIVE_EMOJIS["leaderboard"]
BROADCAST_EMOJI = LIVE_EMOJIS["broadcast"]
ADMIN_EMOJI = LIVE_EMOJIS["admin"]
GLOBE_EMOJI = LIVE_EMOJIS["globe"]
REMOVE_EMOJI = LIVE_EMOJIS["remove"]
SKIPPED_EMOJI = LIVE_EMOJIS["skipped"]
...
async def start(event):
    ...
    # Create your custom free emoji with ID
    YOUR_FREE_EMOJI_ID = "6098173134421104260"  # Replace with your actual free emoji ID from @getidsbot
    free_emoji = emoji_with_id('🆓', YOUR_FREE_EMOJI_ID)
    
    # Create premium emoji
    YOUR_PREMIUM_EMOJI_ID = "5767137507879685567"  # Replace with your actual premium emoji ID
    premium_emoji = emoji_with_id('💎', YOUR_PREMIUM_EMOJI_ID)
    
    # Create user emoji
    YOUR_USER_EMOJI_ID = "5958417144877160497"
    user_emoji = emoji_with_id('👤', YOUR_USER_EMOJI_ID)
    
    # Create star emoji
    YOUR_STAR_EMOJI_ID = "5983292843836314861"
    star_emoji = emoji_with_id('⭐', YOUR_STAR_EMOJI_ID)
    
    # Create check emoji
    YOUR_CHECK_EMOJI_ID = "6136204644625423818"
    check_emoji = emoji_with_id('🔄', YOUR_CHECK_EMOJI_ID)
    
    # Create card emoji
    YOUR_CARD_EMOJI_ID = "5472250091332993630"
    card_emoji = emoji_with_id('💳', YOUR_CARD_EMOJI_ID)
    
    # Create proxy emoji
    YOUR_PROXY_EMOJI_ID = "5042101437237036298"
    proxy_emoji = emoji_with_id('🔒', YOUR_PROXY_EMOJI_ID)
    
    premium_text = f"{free_emoji} {bold_text('Free')}"
    if is_premium:
        premium = await load_json(PREMIUM_FILE)
        user_data = premium.get(str(user_id), {})
        if user_data:
            ...
            premium_text = f"{premium_emoji} {bold_text(f'Premium ({days_left}d {hours_left}h)')}"
...
━━━━━━━━━━━━━━━━━━━━━
{star_emoji} @Atulfroxt73_bot {free_emoji}"""
...
async def proxy_menu(event):
    ...
    proxy_status = f"{CHECKED_EMOJI} {bold_text('Active:')} `{user_proxy['ip']}:{user_proxy['port']}`" if user_proxy else f"{CROSS_EMOJI} {bold_text('No proxy set')}"
...
• {bold_text('Plan:')} {premium_text}
• {bold_text('Proxy:')} {CHECKED_EMOJI if await get_user_proxy(user_id) else CROSS_EMOJI} {bold_text('Active' if await get_user_proxy(user_id) else 'None')}
...
━━━━━━━━━━━━━━━━━━━━━
{STAR_EMOJI} @Atulfroxt73 {STAR_EMOJI}"""
