...
async def start(event):
    ...
    message = f"""{CHECK_EMOJI} {bold_text('Welcome to Shopify CC Checker')}

{CHECKMARK_EMOJI} {bold_text('High-speed Shopify gateway checker')}
{CHECKMARK_EMOJI} {bold_text('Supports all proxy formats')}
{CHECKMARK_EMOJI} {bold_text('Multi-site rotation with retry logic')}

{HEART_EMOJI} {bold_text('Use the menu below to get started:')} {HEART_EMOJI}
